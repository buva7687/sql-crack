...
- **VSIX package bloat**: Updated `.vscodeignore` to exclude `coverage/`, `docs/.venv/`, `out-cjs/`, `tests/`, `examples/`, `scripts/`, `youtube/`, and other dev-only files. Reduces packaged files from ~1548 to 16.
