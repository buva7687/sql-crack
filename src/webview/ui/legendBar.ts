...
export function createLegendBar(container: HTMLElement, callbacks: LegendBarCallbacks): HTMLDivElement {
    ...
    } catch (e) { window.debugLogging && console.debug('[legendBar] localStorage read failed:', e); }
...
export function toggleLegendBar(show?: boolean): void {
    ...
    } catch (e) { window.debugLogging && console.debug('[legendBar] localStorage write failed:', e); }
